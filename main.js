/*
 * 🏰 소환사의 협곡 Bot - FINAL VERSION (v1.2.3)
 * - 기능 보강: 관리자 레벨 수정 시 포인트 자동 연동, 프로필 메뉴 세분화
 * - UI 통일: 비회원 메뉴 및 로그인 과정 UI 표준화, 불필요한 꼬리말 제거
 * - 로직 수정: 모든 알림(성공/실패) 후 자동 화면 복귀(Callback) 강제 적용
 */
...
var MAX_LEVEL = 30;
var POINT_PER_LEVEL = 5; // 레벨당 지급 포인트
