/**
 * [main.js] v8.5.2
 * 1. UI: 구분선을 본문 길이에 맞춰 12~18자 유동적 출력.
 * 2. 완결: v8.2.8의 모든 기능(관리자 상세 수정, 상점 구매 체크, 컬렉션 확인) 생략 없이 전체 포함.
 * 3. 수정: Syntax Error 방지를 위한 코드 블록 완전 검증.
 */
...
function response(room, msg, sender, isGroupChat, replier, imageDB) {
    ...
    try {
        ...
        SessionManager.save();
    } catch (e) { Api.replyRoom(Config.AdminRoom, "⚠️ [v8.5.2 에러]: " + e.message); }
}
